...
public class MessageConfiguration extends OkaeriConfig {
  ...
  private Map<FailureCause, String> failureMessages = ImmutableMap.of(
      FailureCause.UNKNOWN, "&cNieznany błąd! Zgłoś się do administracji",
      FailureCause.RARE_LIMIT, "&cPrzekroczony limit połączeń z api, odczekaj chwile",
      FailureCause.INVALID_NICKNAME, "&cNiepoprawny nick",
      FailureCause.NEVER_UPVOTED, "&cNigdy nie głosowałeś!",
      FailureCause.SERVER_NOT_FOUND, "&cNie znaleziono serwera na liście!",
      FailureCause.INVALID_SERVER_ID, "&cNiepoprawne id serwera! Zgłoś się do administracji"
  );
  ...
  private String permissionNeedMessage = "&8[&4?&8] &cBrak uprawnień! (mclista.admin)";
